...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any):
        #Delete existing data in database for creating slug
        ...
        content = [
            ...
            "Online learning platforms offer flexible and accessible education opportunities, democratizing access to knowledge and empowering learners to pursue their educational goals.",
